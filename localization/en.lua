return {
	...
	Locs = {
		...
		CLEAN_URLS_CLEAR_HELP                     = "Delete all rules.",
		CLEAN_URLS_LIST_HELP                      = "List rules.",
		CLEAN_URLS_REMOVE_HELP                    = "Remove a rule.",
		CLEAN_URLS_ADD_HELP                       = "Add a rule",
		CLEAN_URLS_DEFAULT_HELP                   = "Restore default rules",
		CLEAN_URLS_RULES_RESTORED                 = "The filter list has been reset.",
