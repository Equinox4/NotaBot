...
return {
	...
	Locs = {
		...
		CLEAN_URLS_RULE_ADDED                     = "Règle ajoutée : `%s %s`",
		CLEAN_URLS_RULE_REMOVED                   = "Règle supprimée : `%s %s`",
		CLEAN_URLS_RULES_CLEARED                  = "Toutes les règles ont été supprimées",
		CLEAN_URLS_RULES_HEADER                   = "Liste des domaines filtrés",
		...
		CLEAN_URLS_CLEAR_HELP                     = "Supprime tous les filtres d'urls.",
		CLEAN_URLS_LIST_HELP                      = "Liste les filtres d'urls.",
		CLEAN_URLS_REMOVE_HELP                    = "Supprime un filtre d'url.",
		CLEAN_URLS_ADD_HELP	                      = "Ajoute un filtre d'url.",
		CLEAN_URLS_DEFAULT_HELP                   = "Restaure les filtres par défaut",
		CLEAN_URLS_RULES_RESTORED                 = "La liste des filtres a été réinitilisée.",
